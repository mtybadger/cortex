 ...
 */
export async function build(rootFile: string, langId: string, buildLoop: (quiet: boolean) => Promise<void>, recipeName?: string, quiet: boolean = false) {
