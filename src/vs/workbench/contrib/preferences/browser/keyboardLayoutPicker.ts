...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Cortex in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Cortex and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
