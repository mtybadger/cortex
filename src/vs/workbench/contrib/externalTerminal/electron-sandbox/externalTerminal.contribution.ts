		...
		configurationRegistry.registerConfiguration({
			...
			properties: {
				'terminal.explorerKind': {
					...
					enumDescriptions: [
						nls.localize('terminal.explorerKind.integrated', "Use Cortex's integrated terminal."),
				...
				'terminal.sourceControlRepositoriesKind': {
					...
					enumDescriptions: [
						nls.localize('terminal.sourceControlRepositoriesKind.integrated', "Use Cortex's integrated terminal."),
