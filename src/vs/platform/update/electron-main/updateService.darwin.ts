...
export class DarwinUpdateService extends AbstractUpdateService implements IRelaunchHandler {
	...
	private onUpdateDownloaded(update: IUpdate): void {
		...
		type UpdateDownloadedClassification = {
			owner: 'joaomoreno';
			version: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The version number of the new Cortex that has been downloaded.' };
			comment: 'This is used to know how often Cortex has successfully downloaded the update.';
		};
